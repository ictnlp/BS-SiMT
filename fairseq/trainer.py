...
class Trainer(object):
    ...
    def init_meters(self, args):
        ...
        self.meters['first_loss'] = AverageMeter() #胶囊网络相关参数
        self.meters['second_loss'] = AverageMeter()
        if args.fp16:
...
#                ), 'Fatal error: gradients are inconsistent between workers'
        ...
        try:
            ...
            self.meters['first_loss'].update(logging_output.get('first_loss', 0), sample_size)
            self.meters['second_loss'].update(logging_output.get('second_loss', 0), sample_size)
