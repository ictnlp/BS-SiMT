...
def get_parser(desc, default_task='translation'):
    ...
    parser.add_argument('--latency',type=int, default=1024, metavar='N',
                        help='the latency of wait-k')
    parser.add_argument("--probability", type=float, default=0.5, metavar='D',
                        help='the decoding probability')
